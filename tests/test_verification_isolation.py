...
class TestVerificationIsolation:
    ...
    def test_verify_uses_manifest_test_sample_without_default_voice(self, tmp_path):
        engine = MagicMock()
        engine.check_request.return_value = (True, "OK")

        plugin_dir = tmp_path / "tts_mock"
        sample_path = plugin_dir / "fixtures" / "reference.wav"
        ...
        plugin = LoadedPlugin(
            ...
            manifest={
                "engine_id": "mock",
                "display_name": "Mock",
                "test_sample": "fixtures/reference.wav",
            },
            engine=engine,
        )
