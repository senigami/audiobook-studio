...
from app.db.state import put_job, get_jobs, Job
...
def mock_state(tmp_path):
    ...
    with patch("app.db.state_helpers.get_state_file", return_value=state_file), \
         patch("app.db.state_jobs.get_state_file", return_value=state_file):
        yield state_file
