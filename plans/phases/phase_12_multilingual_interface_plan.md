...
This proposal therefore lives beside Phase 12 as a planning artifact and should be treated as the source for an eventual implementation phase. The canonical spec now lives at `docs/specs/interface-localization.md`, and the working inventory lives in `plans/phases/phase_12_multilingual_interface_examples/`.
...
- `plans/phases/phase_12_polish_and_cleanup.md`
- `plans/master_agnostic_tasks.md`
- `docs/specs/site-shell-and-book-pipeline.md`
- `docs/specs/design-system.md`
- `plans/site_experience_north_star.md`
- `plans/phases/phase_12_multilingual_interface_examples/`
- `docs/specs/interface-localization.md`
