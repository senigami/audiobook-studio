...
`plans/final_release/road_to_v2.md` is the active release checklist. This file is the
...
- [ ] Release blocker tracking now lives in `plans/final_release/road_to_v2.md`.
...
- [x] Voice metadata A-F complete: HF-aligned bundle export/import, icon upload, searchable tags, structured attributes, Voice Lab catalog UI, and docs. Current release tracking lives in `plans/final_release/road_to_v2.md` Stage 4.
