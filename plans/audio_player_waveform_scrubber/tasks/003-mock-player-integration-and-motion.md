...
- Proposal §3 (tape layout, paged motion, grow-upward, click+drag, minimap,
  zoom presets): `plans/audio_player_scrubbing_waveform_proposal.md`
...
- Proposal §6 state model (`AudioLines` toggle dual behavior):
  `plans/audio_player_scrubbing_waveform_proposal.md`
- Locked decisions F3/F4/F5 (audit): `plans/audio_player_waveform_scrubber/00-audit-report.md` §F
- Roadmap W0 sign-off check (gates W1): `plans/audio_player_waveform_scrubber/01-roadmap.md`
