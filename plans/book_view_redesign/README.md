...
the real-app bugs it surfaced. The design **spec** is [`plans/book_view_ia_proposal.md`](../book_view_ia_proposal.md)
...
4. Honor the testing standards in `docs/specs/testing-standards.md` (R1 revert-check bug-fix tests; mock only boundaries).
