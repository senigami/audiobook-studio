...
- Read for intent (do not duplicate): `plans/book_view_ia_proposal.md` §9 **A7** (range/span selection is the future model; current is "paint"; Narrator is book-wide default, span overrides within). Roadmap: `plans/book_view_redesign/01-roadmap.md` Workload 4.
