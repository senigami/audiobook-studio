...
Specs / rules: [`docs/specs/testing-standards.md`](../../../docs/specs/testing-standards.md) (R1 revert-check — a bug-fix test must fail on the pre-fix code). Audio render format is **WAV** for chapter/segment audio (CLAUDE.md, audio-format conventions).
