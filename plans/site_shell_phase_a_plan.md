...
- Spec/docs: none of this touches backend contracts. Add `docs/specs/` entry ONLY if the player bus becomes a contract other features must obey (write `progress-presentation.md` cross-link note if PlayerBar consumes live progress later).
