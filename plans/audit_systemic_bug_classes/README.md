...
`b88e13b8`). The specs in `docs/specs/` remain the source of truth; any task here that
changes behavior must update the matching spec (version bump + changelog row) in the same
change, per `docs/specs/README.md`.
...
3. Execute it under the repo's binding testing standards (`docs/specs/testing-standards.md`,
