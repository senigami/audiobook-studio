...
- `plans/final_release/09_logic_audit.md` and `plans/final_release/audits/` predate this
...
- `docs/specs/progress-presentation.md` 1.3.0/1.3.1 (rules H7) documented the *frontend
