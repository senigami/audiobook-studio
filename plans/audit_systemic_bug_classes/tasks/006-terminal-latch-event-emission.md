...
- Specs to update in the same change (binding, `docs/specs/README.md`):
  `docs/specs/queue-jobs.md` ("broadcast routing", "terminal-reset semantics") and/or
  `docs/specs/live-events.md` — add the ordering guarantee, bump spec_version + changelog.
  `docs/specs/progress-presentation.md` H7 stays, re-labelled defense-in-depth.
