...
- [ ] **1e. Test quality audit (T1+T2)** — doc 17: classify queue/job/segment/progress tests, delete vacuous & mocked-out ones, rewrite real scenarios. Runs after 1b so the new tests are audited in the same pass; T1+T2 gate Stage 1 exit.
