...
- [ ] Create `docs/specs/plugin_template/` in the `audiobook-factory` repo.
- [ ] Copy the file contents from §2–§7 above into the following paths:
  - `docs/specs/plugin_template/manifest.json`
  - `docs/specs/plugin_template/settings_schema.json`
  - `docs/specs/plugin_template/requirements.txt`
  - `docs/specs/plugin_template/README.md`
  - `docs/specs/plugin_template/plugin/__init__.py` (empty)
  - `docs/specs/plugin_template/plugin/server/__init__.py` (empty)
  - `docs/specs/plugin_template/plugin/server/engine.py`
  - `docs/specs/plugin_template/plugin/studio/__init__.py` (empty)
  - `docs/specs/plugin_template/plugin/studio/handler.py`
  - `docs/specs/plugin_template/assets/.gitkeep`

**Acceptance:** `ls docs/specs/plugin_template/` lists all of the above files.

### Step 2 — Install template as a test plugin

- [ ] Symlink or copy `docs/specs/plugin_template/` to `plugins/tts_template/`
