...
1. **Hard filters** (eliminate before scoring): `languages` must include `project_language`.
   ...
   > rank. **OWNER-VETOABLE:** if class should be a hard filter, move it from rule 2 to rule 1.
