...
- **S4 — tts_xtts studio handlers** migrated to ctx (handler/bake/segments/standard_handler/voice_adapter; adapter.py is app-side — audit only). Manifest gains version fields. Acceptance: `grep -rn "from app\." plugins/tts_xtts/plugin/studio/` → 0.
