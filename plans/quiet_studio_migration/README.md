...
- Canonical written spec (update in lockstep): `docs/specs/design-system.md` (+ `docs/specs/voice-tone.md` for copy)
...
- **Commit isolation** — a concurrent agent is consolidating `plans/`; keep commits scoped (`INV-8`).
