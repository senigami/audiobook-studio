...
- Added `plans/phase_11_audit.md` as the Phase 11 entry point.
- Replaced stale Phase 11 handoff, audit, and inventory documents with a concise charter and active task board.
- Added `plans/implementation/phase_11_remaining_work.md` for app-problem triage and remaining cleanup.
