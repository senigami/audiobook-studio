...
- Voice-job workers may opt into bridge-backed sample synthesis behind this flag while the legacy queue still owns scheduling, restart recovery, and job completion bookkeeping
