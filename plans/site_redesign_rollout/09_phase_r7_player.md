...
styleguide + `frontend/src/demo/stages/siteMockup` PlayerBar. Spec: docs/specs/audio-player.md
...
- Spec: bump docs/specs/audio-player.md (§5 waveform → shipped; transport/scope sections updated) +
