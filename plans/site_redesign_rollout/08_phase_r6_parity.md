...
**Read first** `plans/site_redesign_rollout/02_capability_inventory.md` (the whole file);
...
**Read first** `99_progress_log.md` (Found bugs + open questions); `plans/master_agnostic_tasks.md`
(existing format — match it).

**Create/Modify** `plans/master_agnostic_tasks.md`; `99_progress_log.md` (mark each bug
...
**Out of scope** Capturing new screenshots; `docs/specs/` (no behavior contracts changed by a
...
- [ ] Found-bugs list fully dispositioned; real bugs live in `plans/master_agnostic_tasks.md`.
