...
against the live code and the canonical specs. Where a subsystem is now owned by a `docs/specs/`
...
index). This report is a narrative for documentation; the canonical `docs/specs/` files are the
binding contracts.
