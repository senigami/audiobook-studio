...
Mirrors tts_engines/tts_xtts/tests/test_run_test_shared_boilerplate.py. Voxtral's run_test() differs
...
def _make_isolated_plugin_dir(tmp_path: Path) -> Path:
    ...
    tts_engines/tts_voxtral/plugin/server/engine.py depth (engine.py -> server -> plugin -> root)."""
