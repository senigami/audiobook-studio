...
def test_xtts_plugin_routes_script_to_batch_generator(tmp_path, monkeypatch):
    ...
    def fake_generate_script(*, script_json_path: Path, out_wav: Path, on_output, cancel_check, speed: float, task_id: str | None = None, engine_settings: dict | None = None) -> int:
