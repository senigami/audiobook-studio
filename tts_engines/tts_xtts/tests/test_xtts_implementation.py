...
from tts_engines.tts_xtts.plugin.core.implementation import (
...
def test_xtts_generate_success(mock_on_output, mock_cancel_check):
    with patch("tts_engines.tts_xtts.plugin.core.implementation.XTTS_ENV_ACTIVATE") as mock_activate, \
...
def test_migrate_speaker_latent_to_profile(tmp_path):
    ...
    with patch("tts_engines.tts_xtts.plugin.core.implementation.get_speaker_latent_path", return_value=cached_latent):
