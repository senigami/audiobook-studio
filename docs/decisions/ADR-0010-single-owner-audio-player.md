...
**Date:** 2026-06-13  
**Status:** Accepted (implementation lands in the redesign Phase R4; see `plans/site_redesign_rollout/06_phase_r4_player_review.md`)  
...
The contract is specified in `docs/specs/audio-player.md`.
