...
SECTIONS = [
    ...
    ("getting-started", "Getting Started", [
        P("requirements", "Requirements",
          ...
          ["OS support (macOS / Linux / Windows)", "Python 3.11, Node 18+, ffmpeg",
        ...
        P("installation", "Installation Paths",
          ...
          ["Pinokio (easiest)", "From source (developers)", "One-command launcher setup", "Demo library option"],
    ...
    ("concepts", "Core Concepts", [
        ...
        P("engines-overview", "Engines Overview",
          ...
          ["Local engines — XTTS is the only engine installed by default",
           ...
           "Composite (mixed) synthesis", "Add more engines as plugins"],
          ["engine", "local", "cloud", "default", "xtts", "voxtral", "composite", "plugin", "api key"]),
    ...
    ("user-guide", "User Guide", [
        ...
        P("troubleshooting", "Troubleshooting & FAQ",
          ...
          ["Failed jobs & retries", "Voice quality", "Enabling an optional cloud engine", "Long-sentence warnings"],
          ["troubleshooting", "faq", "help", "errors", "failed"]),
    ]),

    ("engines", "Engines & Voice Cloning", [
        P("xtts", "Local Engine (XTTS Default)",
          "The private, local cloning engine — the only engine installed by default. XTTS is the bundled example.",
          ["Why a local engine is the default", "What XTTS is & GPU needs",
           "Latents & the voice profile", "Strengths and tuning"],
          ["local engine", "default", "xtts", "coqui", "gpu", "latent"]),
        P("voxtral", "Cloud Engines (e.g. Voxtral)",
          "Optional, opt-in cloud engines you enable with an API key — none are installed by default. Voxtral (Mistral-hosted) is one example.",
          ["Why cloud engines are optional & opt-in", "Enabling a cloud engine with an API key",
           "What data leaves your machine", "Voxtral as a worked example"],
          ["cloud engine", "optional", "api key", "voxtral", "mistral"]),
    ...
    ("plugin-sdk", "Plugin SDK", [
        ...
        P("behavior-metadata", "Behavior Metadata",
          ...
          ["text_chunk_limit / split target", "progress_pattern parsing",
           "settings_schema.json + x-ui rendering hints", "Per-voice settings declaration"],
          ["behavior", "metadata", "chunk limit", "progress pattern", "settings schema", "x-ui"]),
        ...
        P("standalone-repos", "Portable Core & Standalone Repos",
          ...
          ["Engine repo layout (XTTS as the example)", "CLI entry point & dependency path",
