...
import { type ProgressBarTestConfig, type ProgressBarStatus, type ProgressBarCheckpointMode, STATUS_OPTIONS, CHECKPOINT_MODES } from '@tests/helpers/ProgressBarTestTypes';
import { FieldLabel, clamp01 } from '@tests/helpers/ProgressBarTestHelpers';
