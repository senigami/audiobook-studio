/**
 * Voice attribute taxonomy vocabulary — statically bundled from
 * design-docs/specs/voice-taxonomy.json taxonomy_version "1.0". Update both
 * this const and the source JSON when the taxonomy version bumps.
 */
...
export const taxonomy: { sections: TaxonomySection[] } = {
    sections: [
        {
...
export function getSection(key: string): TaxonomySection | undefined {
