...
1. Before and after **any** review, of any kind or size — ad-hoc, `review-adversarial`, `review-pr`, a `fusion-reasoning` panel, or `review-gate` (Fable) — read [`review-learning.md`](/Users/stevendunn/GitHub-Steven/audiobook-factory/.agent/rules/review-learning.md) and load the matching `design-docs/checklists/*.md` file(s); every confirmed finding must feed a checklist update in the same change.
