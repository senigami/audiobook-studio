...
- `design-docs/lessons/INDEX.md` if a lesson was learned (see the lessons discipline).
...
- The code-map queue: confirm every mapped-source change from today has its
  `design-docs/code-map/queue/` entry (the Stop hook backstops this, but check).
