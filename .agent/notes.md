...
- Session handoffs, branch status, and temporary CI context belong in the ignored `.memory/` directory (`HANDOFF.md`/`state.json`/`log.md`) or in explicit phase handoff artifacts under `design-docs/plans/implementation/`, not in this repo-persistent notes file.
