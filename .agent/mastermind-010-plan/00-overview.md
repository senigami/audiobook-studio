...
- Specs bumped: `design-docs/specs/engines-and-plugins.md`, `design-docs/specs/install-distribution.md`;
  wiki changelog entry; code-map changelog-queue entries in `design-docs/code-map/queue/`.
...
Every task touching mapped code appends a code-map changelog-queue entry (`design-docs/code-map/queue/`).
