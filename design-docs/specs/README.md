...
| Interface localization / locale packs | `interface-localization.md` | `site-shell-and-book-pipeline.md` (shell/book labels), `design-system.md` (layout expansion), `design-docs/plans/phases/phase_12_multilingual_interface_examples/` |
