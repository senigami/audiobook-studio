...
The settings page follows a tabbed layout pattern as described in `design-docs/plans/v2_settings_architecture.md`. Key rules for implementation:
...
- `design-docs/plans/v2_settings_architecture.md` — full Settings page UX specification
- `design-docs/plans/v2_plugin_sdk.md` — engine card data and settings schema format
- `design-docs/plans/v2_tts_server.md` — health data for engine badges and About tab
- `design-docs/plans/v2_voice_system_interface.md` — voice module management concept
- `design-docs/plans/v2_chapter_editor_workflow.md` — editor workflow requirements
