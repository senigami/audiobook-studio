...
- `design-docs/plans/v2_plugin_sdk.md` — plugin contract and discovery
- `design-docs/plans/v2_queuing_system.md` — queue design and task hierarchy
- `design-docs/plans/v2_local_tts_api.md` — API task class and priority policy
- `design-docs/plans/implementation/voice_engine_impl.md` — file-level implementation details
