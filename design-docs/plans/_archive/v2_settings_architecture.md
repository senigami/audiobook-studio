...
- `design-docs/plans/v2_plugin_sdk.md` — settings schema format and engine card data
- `design-docs/plans/v2_local_tts_api.md` — API tab requirements
- `design-docs/plans/v2_tts_server.md` — TTS Server health data for About tab
- `design-docs/plans/phases/phase_7_editor_and_voice_ux.md` — Phase 7 deliverables
