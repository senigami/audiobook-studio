...
- `design-docs/plans/v2_folder_structure.md`
- `design-docs/plans/v2_voice_system_interface.md`
- `design-docs/plans/v2_queuing_system.md`
- `design-docs/plans/v2_progress_tracking.md`
- `design-docs/plans/v2_chapter_editor_workflow.md`
- `design-docs/plans/v2_project_library_management.md`
- `design-docs/plans/v2_conversion_roadmap.md`
- `design-docs/plans/v2_tts_server.md`
- `design-docs/plans/v2_plugin_sdk.md`
- `design-docs/plans/v2_local_tts_api.md`
- `design-docs/plans/v2_settings_architecture.md`
