...
- `design-docs/plans/v2_tts_server.md` — TTS Server process that executes synthesis
- `design-docs/plans/v2_plugin_sdk.md` — plugin contract that engines implement
- `design-docs/plans/v2_queuing_system.md` — orchestrator that schedules API tasks
- `design-docs/plans/v2_settings_architecture.md` — API settings tab
- `design-docs/plans/phases/phase_5_orchestrator.md` — Phase 5 deliverables including ApiSynthesisTask
- `design-docs/plans/phases/phase_9_plugins_and_api.md` — Phase 9 deliverables including authentication and rate limiting
