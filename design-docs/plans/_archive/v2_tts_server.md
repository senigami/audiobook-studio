...
- `design-docs/plans/v2_plugin_sdk.md` — plugin contract and packaging
- `design-docs/plans/v2_voice_system_interface.md` — engine contract and bridge architecture
- `design-docs/plans/v2_local_tts_api.md` — external API that proxies through the TTS Server
- `design-docs/plans/phases/phase_5_orchestrator.md` — Phase 5 deliverables that include TTS Server setup
- `design-docs/plans/implementation/voice_engine_impl.md` — file-level implementation blueprint
