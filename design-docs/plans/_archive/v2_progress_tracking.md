...
> **SUPERSEDED by `design-docs/plans/progress_routing_unification/` (shipped 2026-06-18).** Routing is now single-source at the event-builder layer (`app/api/contracts/events.py`); reconciliation, ETA, and confidence are all implemented. The design intent documented here is retained for history; `design-docs/specs/progress-presentation.md` and `design-docs/decisions/ADR-0012` are the live references.
...
- `design-docs/plans/implementation/progress_service_impl.md`
- `design-docs/plans/implementation/domain_data_model.md`
- `design-docs/plans/implementation/frontend_state_impl.md`
