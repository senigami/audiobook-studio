...
a calculated ETA. See `../00-architecture-map.md` D4 + §4A.8 in `design-docs/specs/progress-presentation.md`.
...
- `design-docs/specs/progress-presentation.md` §4A.4 (ceiling), §4A.8 (crossfade calculated→observed).
