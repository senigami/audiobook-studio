...
UI receives — no matter which path emitted it — honors `design-docs/specs/progress-presentation.md` §4A
...
## Execution rules
- TDD + R1 revert-check per `design-docs/specs/testing-standards.md`.
