...
| **W10** | Backend namespace: `plugins/`→`tts_engines/` rename shipped; remaining voice-namespace rename + code-org | `master_agnostic_tasks` (`organizational_cleanup` done, folder retired 2026-07-17) | structural |
