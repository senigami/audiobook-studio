...
- `design-docs/specs/audio-player.md` 1.6.0 §5.2 (tape interaction), §5.3 (fixed-grid sampling — binding), §5.4 (browser peak provider)
- `design-docs/plans/audio_player_waveform_scrubber/00-audit-report.md §E` — F4 (single-owner), F5 (reduced motion is free under paged-default)
- `design-docs/plans/audio_player_waveform_scrubber/01-roadmap.md` — "Port, don't re-derive"; W2-006 description; architecture clarified section (fixed-grid binding)
- `design-docs/specs/audio-player.md §2.3` — single-owner invariants; conversion grep
- `design-docs/decisions/ADR-0010-single-owner-audio-player.md` — single `<audio>` invariant
