...
- `design-docs/specs/data-model.md` updated with peaks field (confirmed from 011 — verify it landed).
...
- Roadmap: `design-docs/plans/audio_player_waveform_scrubber/01-roadmap.md` (W3, task 012)
- Spec §5.4 (peaks data — browser-first below cap, sidecar above; one seam): `design-docs/specs/audio-player.md`
- Spec §5.3 (fixed-grid sampling — binding): `design-docs/specs/audio-player.md`
...
- Task 010: `design-docs/plans/audio_player_waveform_scrubber/tasks/010-peaks-source-abstraction.md`
- Task 011: `design-docs/plans/audio_player_waveform_scrubber/tasks/011-backend-peaks-sidecar-emission.md`
...
- `design-docs/specs/testing-standards.md` — R1 revert-check, R3 contract-shaped frames, R4 no sleep
