...
- [ ] **006** — Backend namespace rename + code-org — [task file](master_fix_plan/tasks/006-backend-namespace-and-codeorg.md) · [agnostic tasks](active/master_agnostic_tasks.md)
  ...
  - [ ] Phase-12 owner decisions: generic plugin setup-loop (implement or defer), voice-settings placement, ~~system-API surface for 3rd-party controllers~~ (verified adequate + auth gap fixed 2026-07-09, see `active/master_agnostic_tasks.md`), Settings→API tab honesty
