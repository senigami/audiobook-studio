...
- [ ] **006** — Backend namespace rename + code-org — [task file](master_fix_plan/tasks/006-backend-namespace-and-codeorg.md) · [agnostic tasks](active/master_agnostic_tasks.md)
  ...
  - [ ] Phase-12 owner decisions: generic plugin setup-loop (implement or defer), system-API surface for 3rd-party controllers, Settings→API tab honesty (voice-settings placement done — see master_agnostic_tasks.md)
