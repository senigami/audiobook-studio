...
6. Update specs (W6): `design-docs/specs/live-events.md` (preparing window / ETA suspension semantics) and
   `design-docs/specs/queue-jobs.md` (per-group phase vs monotonic status); bump versions + changelog rows.
