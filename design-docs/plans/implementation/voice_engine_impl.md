...
- `design-docs/plans/v2_tts_server.md` — full TTS Server architecture specification
- `design-docs/plans/v2_plugin_sdk.md` — plugin contract, manifest schema, naming rules
- `design-docs/plans/v2_voice_system_interface.md` — engine contract and bridge design
- `design-docs/plans/v2_local_tts_api.md` — external API that proxies through TTS Server
- `design-docs/plans/phases/phase_5_orchestrator.md` — Phase 5 deliverables
