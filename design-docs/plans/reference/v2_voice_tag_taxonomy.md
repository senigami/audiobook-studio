...
> (`design-docs/plans/v2_huggingface_voice_repo_spec.md`), the export/upload generator, the AI casting
> engine (`design-docs/plans/v2_voice_metadata_and_casting.md`), and the Voice Lab UI. If a value
...
- Sibling specs: `design-docs/plans/v2_huggingface_voice_repo_spec.md`,
