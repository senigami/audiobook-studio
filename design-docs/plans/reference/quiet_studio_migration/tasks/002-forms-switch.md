...
| `design-docs/specs/design-system.md` | §6: add `Switch` component entry + updated `GlassInput` entry; bump `spec_version`; changelog row |
...
11. **Update `design-docs/specs/design-system.md` §6**: add a `Switch` entry:
    ```
...
- `design-docs/specs/design-system.md` §6: `Switch` entry added; `GlassInput` entry updated.
- `spec_version` bumped.
- Changelog row added.
