...
| `design-docs/specs/design-system.md` | §4.1 typeface section: record Geist/Geist Mono/Source Serif 4 as self-hosted; bump `spec_version` to 1.5.0; add changelog row |
...
- `design-docs/specs/design-system.md` §4.1: rewrite typeface paragraph as described in step 7.
