...
Full specification: `design-docs/plans/v2_tts_server.md`
...
Full specification: `design-docs/plans/v2_plugin_sdk.md`

## 12. Implementation References

- `design-docs/plans/implementation/domain_data_model.md`
- `design-docs/plans/implementation/voice_engine_impl.md`
