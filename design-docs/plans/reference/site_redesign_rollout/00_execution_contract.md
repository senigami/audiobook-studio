...
1. `design-docs/plans/site_experience_north_star.md` §12 decision log (owner decisions, rounds 1–5) — WHAT.
...
- **R-D. Tests move with code.** Existing tests for a moved component get updated imports, not
  ...
  in `design-docs/specs/testing-standards.md` — R1–R4 apply).
