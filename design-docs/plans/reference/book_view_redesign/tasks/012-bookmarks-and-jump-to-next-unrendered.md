...
- Read for intent (do not duplicate): `design-docs/plans/book_view_ia_proposal.md` §6.8. Note the **division of labor**: the *auto "last-edited"* bookmark (one per chapter, moves with edits) is **task 008**, NOT this task. This task is the **named/global collection** plus the unrendered-gap navigation.
