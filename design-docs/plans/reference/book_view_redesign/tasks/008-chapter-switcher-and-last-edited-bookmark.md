...
- Spec: `design-docs/plans/book_view_ia_proposal.md` §6.3 (header: `Contents ▾` switcher + prev/next + bookmark; ~16 chapters → dropdown, no permanent rail), §6.8 (auto "last-edited" bookmark — one per chapter, moves with edits, resumes on open; book remembers last chapter opened), §6.1 steps 2 & 10.
- Roadmap: `design-docs/plans/book_view_redesign/01-roadmap.md` — Workload 3; `007 ──► 008`; blocks nothing.
