...
- Spec: `design-docs/plans/book_view_ia_proposal.md` §6.1–§6.3 (converged target IA), §11 (Backups adopted as a book-level surface; "Manuscript" retired; "Casting"→"Cast").
- Roadmap: `design-docs/plans/book_view_redesign/01-roadmap.md` — Workload 2; `005 ──► 006` and `005 ──► 007`.
