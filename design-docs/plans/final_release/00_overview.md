...
**Created 2026-06-10** from a full audit of the codebase, `design-docs/plans/`, and `wiki/`, plus owner directives. This folder is the coordinated, execution-ready plan that takes Studio 2.0 from Phase 12.2 to public release. It supersedes nothing wholesale — the existing `design-docs/plans/` docs remain the design record — but where this folder and an older plan disagree, **this folder wins** (each conflict is itemized in doc 01).
...
| Doc | What it is |
|---|---|
| [01](01_discrepancies_and_corrections.md) | Wiki/design-docs/plans/code discrepancy catalog with corrections and an ownership map |
...
| [03](03_plugin_interface_template.md) | Copyable standalone-plugin template (`design-docs/specs/plugin_template/`) — the "fill in these functions" checklist for plugin authors |
