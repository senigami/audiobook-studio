...
7. Append a code-map changelog entry per this repo's code-map convention (new file + two modified files).
...
- [ ] A code-map changelog entry has been added for this change.
