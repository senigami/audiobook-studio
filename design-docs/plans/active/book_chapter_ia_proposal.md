...
relates to: design-docs/plans/ethereal-booping-frost.md (rail/library), audio-player.md (PlayerBar transport),
...
3. **Write the implementation plan** (its own `design-docs/plans/` task folder) for the live routing/component restructure.
