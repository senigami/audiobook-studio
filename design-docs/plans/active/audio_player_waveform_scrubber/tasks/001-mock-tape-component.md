...
- Audit report finding F3 (synthetic-but-peak-shaped data requirement):
  `design-docs/plans/audio_player_waveform_scrubber/00-audit-report.md` §E
...
- Proposal §5 HIG guardrails (contrast on glass, targets ≥ 44 pt):
  `design-docs/plans/audio_player_scrubbing_waveform_proposal.md`
- Roadmap W0 task 001: `design-docs/plans/audio_player_waveform_scrubber/01-roadmap.md`
