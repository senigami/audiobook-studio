...
- Roadmap: `design-docs/plans/audio_player_waveform_scrubber/01-roadmap.md` (W3, task 010)
- Spec §5.4 (peaks data — browser-first, server sidecar later; one seam): `design-docs/specs/audio-player.md`
- Spec §5.3 (fixed-grid rendering — binding): `design-docs/specs/audio-player.md`
- Audit Finding F4 (single-owner constraint): `00-audit-report.md §E`
- Task 006 (introduced `usePeaks` and `WaveformTape`): `design-docs/plans/audio_player_waveform_scrubber/tasks/006-tape-renderer-browser-peaks.md`
