...
- [x] Location: `design-docs/plans/v2_settings_architecture.md` already reserves a spot in the General tab. Find the General settings component (likely `frontend/src/pages/Settings/components/GeneralSettingsPanel.tsx` or similar).
...
- [x] Owner decision documented: ChapterEditor is tablet-minimum at 390px (see §3.4 and design-docs/plans/master_agnostic_tasks.md).
...
- [x] Documented the 390px ChapterEditor exception in `design-docs/plans/master_agnostic_tasks.md` — "Known Constraints" section appended.
