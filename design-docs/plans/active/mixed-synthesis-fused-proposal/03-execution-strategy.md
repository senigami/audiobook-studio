...
- **Alongside:** **W6** edits only `design-docs/specs/*` — zero file overlap with code. Draft as the code settles, finalize with the behavior so specs+code land together. No worktree isolation needed.
