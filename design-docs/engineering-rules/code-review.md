...
**Before conducting any review of any kind or size, apply every relevant checklist item for the domain being reviewed** (code quality, security, spec drift, or others as they're added) as a mandatory check, not optional background reading. Anything a checklist doesn't already cover should be captured as a durable review lesson for next time.
