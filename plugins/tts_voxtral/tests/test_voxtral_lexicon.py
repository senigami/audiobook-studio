...
class TestVoxtralBakeLexicon:
    ...
    def _run(self, project_id, lexicon_entries, text="SQL is fast."):
        from plugins.tts_voxtral.plugin.studio import bake as bk
...
class TestVoxtralSegmentsLexicon:
    ...
    def _run(self, project_id, lexicon_entries, text="SQL is fast."):
        from plugins.tts_voxtral.plugin.studio import segments as seg_mod
...
class TestVoxtralHandlerLexicon:
    ...
    def _run(self, project_id, lexicon_entries, text="SQL is fast."):
        from plugins.tts_voxtral.plugin.studio import handler as h_mod
